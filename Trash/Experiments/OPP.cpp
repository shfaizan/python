/*
Topic: OPERATOR PRECEDENCE PARSER in c++
Author: Fizan Shaikh
Id: 17103455
*/
...
int main()
{
    ...
    char op_table[20][20] = {};
    cout<<"How many Productions you want? ";
    cin>>n;
    cin.ignore();
    ...
    cout<<"Terminals in the Production(Number) : ";
    cin>>n2;
    cin.ignore();
    ...
    n2++;
    // Non terminals like 
    cout<<"Non Terminals in the Production(Number) : ";
    cin>>n1;
    cin.ignore();
    for(int i=0;i<n1;i++)
    {
    ...
    while(true)
    {
        ...
        else
        {
            ...
            {
                cout<<"\t\t\tAccept\nString sucssessfully Parsed."<<endl;
                cout<<"The code is compiled thanks"<<endl;
                break;
            }
            else
            {
